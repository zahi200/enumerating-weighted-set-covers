import java.util.*;
public class TeamsEnumerationExp1Top1 {

    private LinkedHashSet<Expert> experts; // all available experts
    private Set<Skill> skills;   // elements to cover by the sets

    public TeamsEnumerationExp1Top1(LinkedHashSet<Expert> experts, Set<Skill> skills) {
    ...
    public Experiment1ValueHolder enumerate(int numOfResults){
        double top1TeamCost = -1;
        int top1TeamCardinality = 0;
        Experiment1ValueHolder result;
        ...
        while((!Q1.isEmpty() || !Q2.isEmpty()) && countPrintedResult<numOfResults){
            ...
            if(cost1 <= cost2){ // this condition includes the case that Q2 is empty
                ...
                if(countPrintedResult == 0){ // this team is the top 1
                    top1TeamCost = cost1;
                    top1TeamCardinality = nextTeam.size();
                }
        ...
        result = new Experiment1ValueHolder(top1TeamCost, top1TeamCardinality);
        return result;
    }
